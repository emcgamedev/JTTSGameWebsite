    ...
    <div class="wrapper">
        ...
        <div id="content" class="p-4">
            <div class="container my-5">
                <h1 class="text-center mb-5">Manage Home Page</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="home-delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" action="home-add.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="home-edit.php" method="POST" enctype="multipart/form-data">
